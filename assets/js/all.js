  ...
  (b = (function () {
    function c(c, d) {
      ...
      (e.defaults = {
        ...
        arrows: !0,
        asNavFor: null,
        prevArrow: `<button type="button" data-role="none" class="slick-prev" aria-label="Previous" tabindex="0" role="button"><em class='fa fa-chevron-left'></em></button>`,
        nextArrow: `<button type="button" data-role="none" class="slick-next" aria-label="Next" tabindex="0" role="button"><em class='fa fa-chevron-right'></em></button>`,
        autoplay: !1,
        autoplaySpeed: 3e3,
        centerMode: !1,
        centerPadding: "50px",
